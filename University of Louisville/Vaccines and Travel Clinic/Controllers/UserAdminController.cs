...
namespace IdentitySample.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,FirstName,LastName,DateOfBirth,Address,City,State,PostalCode")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
